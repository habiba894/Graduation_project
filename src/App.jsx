...
import { FaGoogle, FaEnvelope, FaLock, FaArrowRight, FaSpinner } from 'react-icons/fa';
...
const LoginPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-orange-50 to-gray-100 flex items-center justify-center p-4 relative">
      ...
      <motion.div
        className="absolute top-20 left-20 w-72 h-72 bg-orange-300/20 rounded-full blur-3xl"
      ...
      />
      <motion.div
        className="absolute top-1/2 left-1/3 w-64 h-64 bg-yellow-300/20 rounded-full blur-3xl"
        variants={floatingVariants}
        initial="hidden"
        animate="animate"
      ...
      {/* Mouse follow effect */}
      <motion.div
        className="absolute w-96 h-96 bg-gradient-to-r from-orange-400/10 to-amber-400/10 rounded-full blur-3xl pointer-events-none"
        animate={{
...
<div className="absolute inset-0 flex flex-col justify-center items-start px-12 text-white text-left">
  ...
  >
    <div className="text-3xl drop-shadow-lg tracking-wide font-bold">
    Discover Egypt
    </div>
  </motion.h2>
  ...
  <motion.h3
    ...
    className="text-4xl font-bold text-white mt-2 drop-shadow-md font-bold"
  >
    Waiting for you
  </motion.h3>
  ...
  <motion.p
    ...
    className="text-lg text-white pt-4 font-medium"
  >
    Your journey begins here. Experience the magic of ancient civilization.
  </motion.p>
    ...
    Welcome Back
              ...
              <p className="text-gray-500 text-sm leading-relaxed">
                please sign in to continue your journey and discover breathtaking destinations across the world.
              </p>
            </motion.div>

            {/* Form */}
            <form onSubmit={formik.handleSubmit} className="space-y-6">
              {/* 🔧 Email Field - Email Address label shifted left */}
              <motion.div variants={itemVariants}>
                ...
                <div className="relative group">
                  ...
                  <input
                    ...
                    } rounded-2xl focus:outline-none focus:bg-white focus:ring-4 focus:ring-orange-500/10 transition-all duration-300 placeholder-gray-400`}
  ...
  className="absolute right-4 top-1/2 -translate-y-1/2 text-gray-500 hover:text-orange-500 transition-all duration-200"
>
  <motion.div
  ...
  >
    {showPassword ? <FaEyeSlash /> : <FaEye />}
            ...
            {/* 🔧 Divider - my-10 بدل my-8 */}
            <motion.div variants={itemVariants} className="relative my-10">
              <div className="absolute inset-0 flex items-center">
                <div className="w-full border-t border-gray-200"></div>
              </div>
              <div className="relative flex justify-center">
                <span className="px-4 bg-white/55 text-gray-400 text-xs font-semibold uppercase tracking-wider">
                  or continue with
                </span>
              </div>
            </motion.div>
            ...
            <motion.div variants={itemVariants}>
              <button
                type="button"
                className="w-full flex items-center justify-center gap-3 py-4 bg-white border-2 border-gray-200 rounded-2xl hover:border-orange-300 hover:bg-orange-50/50 hover:shadow-lg hover:shadow-orange-500/10 transition-all duration-300 group"
              >
            ...
            <motion.p variants={itemVariants}   className="pt-6 text-center text-sm text-gray-500">
              ...
              >
                Sign Up
                <span className="absolute -bottom-0.5 left-0 w-0 h-0.5 bg-gradient-to-r from-orange-500 to-amber-500 transition-all duration-300 group-hover:w-full" />
              </a>
            </motion.p>
          </motion.div>
        </div>
