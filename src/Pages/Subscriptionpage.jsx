...
export default function SubscriptionPage() {
  ...
  const handlePayment = async (planType, amount) => {
    try {
      ...
      toast.success(
        data?.message || "Payment session created"
      );
    } catch (error) {
      ...
      <div className="max-w-3xl mx-auto px-4 pt-4 pb-24">
        <div className="text-center mb-10" data-aos="fade-up">
          ...
          <p className="text-gray-400 mt-3 text-sm max-w-sm mx-auto leading-relaxed">
            Unlock premium features and make your trips even
            more unforgettable.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-14">
          ...
          >
            ...
            <button
              onClick={() =>
                handlePayment("WEEKLY", weeklyPrice)
              }
          ...
          >
            ...
            <button
              onClick={() =>
                handlePayment("MONTHLY", monthlyPrice)
              }
              disabled={paymentLoading}
              ...
              style={{
                ...
                boxShadow:
                  "0 6px 24px rgba(232,71,42,0.35)",
              }}
            >
