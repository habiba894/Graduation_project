...
const weeklyFeatures = ["Packing tips", "Offline mode", "Simulate trip plan"];
  ...
  return (
    <div className="min-h-screen bg-white font-sans overflow-x-hidden">
      ...
      <div className="max-w-3xl mx-auto px-4 pt-4 pb-24">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-14">
          ...
          >
            ...
            >
              <CalendarDaysIcon className="w-6 h-6" style={{ color: accent }} />
            </div>
            ...
            <div className="flex items-baseline gap-1 mb-7">
              <span className="text-5xl font-extrabold" style={{ color: dark }}>
                ${weeklyPrice}
              </span>
            ...
            <button
              className="mt-auto w-full py-3.5 rounded-full border-2 font-semibold text-sm transition-all duration-300 hover:bg-orange-50 hover:scale-[1.02]"
          ...
          >
            ...
            >
              <SparklesIcon className="w-6 h-6" style={{ color: accent }} />
            </div>
            <h3 className="text-xl font-bold mb-1" style={{ color: dark }}>
              Monthly Plan
            </h3>
            ...
            <button
              className="mt-auto w-full py-3.5 rounded-full font-bold text-sm text-white transition-all duration-300 hover:opacity-90 hover:scale-[1.02] active:scale-95"
              style={{
        ...
        <div
          ...
          style={{ borderColor: "#ececec" }}
        >
          <h3 className="text-xl font-bold mb-7" style={{ color: dark }}>
            Compare Plans
          </h3>
      ...
      >
        ...
        {/* Content */}
        <div className="relative z-10 max-w-7xl mx-auto px-6 sm:px-12 lg:px-24 py-20 flex flex-col md:flex-row items-center justify-between gap-12">
          <div className="flex-1">
            ...
            <p className="text-white/62 text-base leading-relaxed max-w-md">
              Subscribe now and start your unforgettable journey with
          ...
          <div className="flex flex-col gap-4 shrink-0 w-full md:w-auto">
            <button
              className="flex items-center justify-center gap-2 px-10 py-4 rounded-full font-bold text-white text-sm transition-all duration-300 hover:scale-105 active:scale-95 whitespace-nowrap"
              style={{
                backgroundColor: accent,
                boxShadow: "0 8px 36px rgba(232,71,42,0.52)",
              }}
            >
              Get Started
            ...
            <button
              className="flex items-center justify-center gap-2 px-10 py-4 rounded-full font-semibold text-sm text-white transition-all duration-300 hover:scale-105 active:scale-95 whitespace-nowrap"
              style={{
                background: "rgba(255,255,255,0.12)",
