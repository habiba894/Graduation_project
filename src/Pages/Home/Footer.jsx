...
const Footer = () => {
  return (
    <footer className="bg-gray-50 px-20 py-12">
      <div className="grid grid-cols-4 gap-10">
        ...
        <div>
          ...
          <p className="text-gray-400 text-sm leading-6 text-left">
        ...
        {/* Quick Links */}
        <div>
          <h3 className="text-[#EE5E44] font-semibold mb-4 text-left">Quick Links</h3>
          <ul className="space-y-3 text-gray-400 text-sm">
            <li className="flex items-center gap-2 cursor-pointer text-left">
              About Us
            </li>
            <li className="flex items-center gap-2 cursor-pointer text-left">
              Terms of Service
        ...
        {/* Support */}
        <div>
          <h3 className="text-[#EE5E44] text-left font-semibold mb-4">Support</h3>
          <ul className="space-y-3 text-gray-400 text-sm text-left flex items-start flex-col">
            <li>Contact</li>
        ...
        <div>
          ...
          <div className="flex items-center bg-white border rounded-full overflow-hidden w-full">
            <input
              type="email"
              placeholder="Your email"
              className="px-4 py-2 text-sm outline-none flex-1"
            />
            <button className="bg-[#EE5E44] w-10 h-10 flex items-center justify-center rounded-full px-2 py-1">
              {/* Arrow SVG */}
              <svg
                width="10"
                height="10"
      ...
      {/* Bottom */}
      <div className="flex justify-between items-center mt-10 pt-6 border-t text-sm text-gray-400">
        <p>© 2026 WanderLust</p>
